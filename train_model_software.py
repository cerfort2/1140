...
import math, time
from SoftwareTrainController import *
from train_model_GUI import *
...
class train_model_software():
    ...
    #Refactored
    def read_station_beacon(self, beacon_val: str):
        self.beacon_list = []
        self.underground_list = []
        self.speed_list = []
    ...
    def read_switch_beacon(self, beacon_val: str):
        self.beacon_list = []
        self.underground_list = []
        self.speed_list = []
    ...
    #occupancy updater
    def update_occupancy(self, inputtedPolarity: bool) -> None:
        if inputtedPolarity != self.current_polarity:

            self.current_polarity = inputtedPolarity
