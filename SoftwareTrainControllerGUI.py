...
class SoftwareTrainControllerGUI(Ui_Form):
    ...
    def connect(self):
        ...
        self.ebrake.clicked.connect(self.swtrain.eBrakePressed)      #check for if ebrake is pushed in manual or automatic
        self.serviceBrake.clicked.connect(self.swtrain.serviceBrakePressed)
        self.announcement.currentTextChanged.connect(self.manualannouncementchange)
