...
class HWTrackControllerGUI(Ui_Form, QObject):
    ...
    def toggleTrack(self):
        ...
        pureOccupancy = []
        for i in range(32): #A1-G32
            pureOccupancy.append(self.greenLine.Waysides[0].getTrack(i).getOccupancy())
        #All for Wayside 2
        for i in range(41): #H33-L73
            pureOccupancy.append(self.greenLine.Waysides[1].getTrack(i).getOccupancy())
        #All for Wayside 3
        for i in range(28): #M74-R101
            pureOccupancy.append(self.greenLine.Waysides[2].getTrack(i).getOccupancy())
        #All for Wayside 4
        for i in range(48): #S102-Y149
            pureOccupancy.append(self.greenLine.Waysides[3].getTrack(i).getOccupancy())
        pureOccupancy.append(self.greenLine.Waysides[0].getTrack(32).getOccupancy()) #Z150
        pureOccupancy.append(self.greenLine.Waysides[1].getTrack(41).getOccupancy()) #Z151/YARD
        newStates = operate.plcCode(pureOccupancy) #Everytime get new occupancy run plc logic in arduino
        self.setNewDataGreenLine(newStates)
        self.setListsOccupancyAutomatic
        self.setListsOccupancyManual
