...
from SoftwareTrainControllerGUI import SoftwareTrainControllerGUI
...
class SWTrainC(QObject):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.swtrain=SoftwareTrainControllerGUI()
...
class God():
    def __init__(self):
        ...
        self.SWtrainController = SWTrainC() 
    ...
    def onTimeoutFunctions(self):
        self.trainController.timeout()
        self.trackModel.setOccupancy()
        self.SWtrainController.timeout()
