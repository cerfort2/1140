...
class TestCTC(unittest.TestCase):
    ...
    def setUp(self):
        # Initialize the CTC instance, and any other required variables
        self.ctc = CTC()
        self.ctc.initialize_ctc()  # You might need to mock some parts of initialize_ctc if it interacts with the UI or external resources

    def test_dispatch_train(self):
        # Set up your test data
        destination = "O88: POPLAR"
        stops = ["L73: DORMONT", "K65: POPLAR"]
...
'I57', 'J58', 'J59', 'J60', 'J61'], [False, False, False, False, False, False, False, False, False, False, False, False, True, False, False, False, False, False, 
